...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1__install__["a" /* default */]);

var AppComponent = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('app', __WEBPACK_IMPORTED_MODULE_2__components_App___default.a);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Gallery__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Gallery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Gallery__);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    install: function install(Vue, options) {
        ...
        Vue.component('gallery', __WEBPACK_IMPORTED_MODULE_1__components_Gallery___default.a);
    }
});
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-15c1b052", Component.options)
  } else {
    hotAPI.reload("data-v-15c1b052", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        legendPos: function legendPos() {
            return _.includes(this.positions, this.legendPosition) && !this.isMobile ? this.legendPosition : 'bottom';
        },
        legendVertical: function legendVertical() {
...
/* harmony default export */ __webpack_exports__["a"] = ({
    computed: {
        ...
        carouselWidth: function carouselWidth() {
            return this.windowWidth - (this.legend && this.legendVertical ? this.thumbnailWidth : 0);
        },
        carouselHeight: function carouselHeight() {
            return this.windowHeight - (this.legend && !this.legendVertical ? this.thumbnailHeight : 0);
        },
        galleryStyle: function galleryStyle() {
            var style = {
        ...
        thumbnailsStyle: function thumbnailsStyle() {
            ...
            var height = !this.legendVertical ? this.thumbnailHeight : this.total * this.thumbnailHeight;
    ...
    methods: {
        ...
        thumbnailStyle: function thumbnailStyle(i) {
            ...
            if (this.legendVertical) {
                style.top = (i - 1) * this.thumbnailHeight + 'px';
                style.left = 0;
            } else {
                style.top = 0;
                style.left = (i - 1) * this.thumbnailWidth + 'px';
            }
    ...
    methods: {
        ...
        onCarouselTouchStart: function onCarouselTouchStart(e) {
            ...
            if (e.touches.length === 1) {
                this.dragStartTime = new Date().getTime();
                this.onCarouselMouseDown(e.touches[0]);
            } else if (e.touches.length >= 2) {
                this.zoomStart = {
                    a: [e.touches[0].clientX, e.touches[0].clientY],
                    b: [e.touches[1].clientX, e.touches[1].clientY]
                };
                console.log(this.zoomStart);
            }
        },
        onCarouselTouchMove: function onCarouselTouchMove(e) {
            this.onCarouselMouseMove(e.touches[0]);
        },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-15c1b052", module.exports)
  }
}
